# Mohammad Anas - Software Engineer Portfolio
...
- **Dynamic Typewriter Effect:** An engaging hero section that types out my core professional identities.
...
- **Zero Dependencies:** Built entirely with pure HTML5, CSS3, and Vanilla JavaScript. No bulky frameworks, ensuring lightning-fast load times.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/MohammadAnas-07/portfolio.git
   ```
